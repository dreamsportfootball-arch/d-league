...
export const PLAYER_IMAGES: Record<string, string> = {
  // L1 - 嘉義諸羅山FC [cite: 1]
  '陳日揚': '/assets/players/嘉義諸羅山FC/陳日揚.png',
  '陳官澤': '/assets/players/嘉義諸羅山FC/陳官澤.png',
  '陳柏翰': '/assets/players/嘉義諸羅山FC/陳柏翰.png',
  '蔡孟勲': '/assets/players/嘉義諸羅山FC/蔡孟勲.png',
  'Jason Chan': '/assets/players/嘉義諸羅山FC/Jason Chan.png',
  '黃子睿': '/assets/players/嘉義諸羅山FC/黃子睿.png',
  '黃偉倫': '/assets/players/嘉義諸羅山FC/黃偉倫.png',
  '王至皓': '/assets/players/嘉義諸羅山FC/王至皓.png',
  '唐毓翔': '/assets/players/嘉義諸羅山FC/唐毓翔.png',
  '林柏辰': '/assets/players/嘉義諸羅山FC/林柏辰.png',
  '李裕玄': '/assets/players/嘉義諸羅山FC/李裕玄.png',
  '鄭州偉': '/assets/players/嘉義諸羅山FC/鄭州偉.png',
  '蔡吉雄': '/assets/players/嘉義諸羅山FC/蔡吉雄.png',
  '郭政達': '/assets/players/嘉義諸羅山FC/郭政達.png',
  '王建翔': '/assets/players/嘉義諸羅山FC/王建翔.png',
  '黃楷堯': '/assets/players/嘉義諸羅山FC/黃楷堯.png',
  '李俊逵': '/assets/players/嘉義諸羅山FC/李俊逵.png',
  
  // L1 - 陳公舘 [cite: 2]
  '李秉錦': '/assets/players/陳公舘/李秉錦.png',
  '林家銘': '/assets/players/陳公舘/林家銘.png',
  '倪柏瑄': '/assets/players/陳公舘/倪柏瑄.png',
  '孫裕程': '/assets/players/陳公舘/孫裕程.png',
  '洪品丞': '/assets/players/陳公舘/洪品丞.png',
  '陳立鑫': '/assets/players/陳公舘/陳立鑫.png',
  '潘志豪': '/assets/players/陳公舘/潘志豪.png',
  '倪天銘': '/assets/players/陳公舘/倪天銘.png',
  '楊俊雄': '/assets/players/陳公舘/楊俊雄.png',
  '劉振仕': '/assets/players/陳公舘/劉振仕.png',
  '曾龍盛': '/assets/players/陳公舘/曾龍盛.png',
  '洪品宇': '/assets/players/陳公舘/洪品宇.png',
  '陳品憲': '/assets/players/陳公舘/陳品憲.png',
  '林紀廷': '/assets/players/陳公舘/林紀廷.png',
  '張誌文': '/assets/players/陳公舘/張誌文.png',
  '吳明威': '/assets/players/陳公舘/吳明威.png',
  '洪彥翔': '/assets/players/陳公舘/洪彥翔.png',
  '王靖堯': '/assets/players/陳公舘/王靖堯.png',
  '李家勳': '/assets/players/陳公舘/李家勳.png',
  '陳俊介': '/assets/players/陳公舘/陳俊介.png',
  
  // L1 - 銅雀足球俱樂部 [cite: 3]
  '李相慶': '/assets/players/銅雀足球俱樂部/李相慶.png',
  '李偉豪': '/assets/players/銅雀足球俱樂部/李偉豪.png',
  '趙南聰': '/assets/players/銅雀足球俱樂部/趙南聰.png',
  '陳揚': '/assets/players/銅雀足球俱樂部/陳揚.png',
  '翁才竣': '/assets/players/銅雀足球俱樂部/翁才竣.png',
  '蘇智龍': '/assets/players/銅雀足球俱樂部/蘇智龍.png',
  '鄭孟育': '/assets/players/銅雀足球俱樂部/鄭孟育.png',
  '郭博彥': '/assets/players/銅雀足球俱樂部/郭博彥.png',
  '施博允': '/assets/players/銅雀足球俱樂部/施博允.png',
  '徐鈺凱': '/assets/players/銅雀足球俱樂部/徐鈺凱.png',
  '劉允閎': '/assets/players/銅雀足球俱樂部/劉允閎.png',
  '杜安': '/assets/players/銅雀足球俱樂部/杜安.png',
  '魏士閔': '/assets/players/銅雀足球俱樂部/魏士閔.png',
  '巫嘉德': '/assets/players/銅雀足球俱樂部/巫嘉德.png',
  '林宴丞': '/assets/players/銅雀足球俱樂部/林宴丞.png',
  '謝侑霖': '/assets/players/銅雀足球俱樂部/謝侑霖.png',
  '張斳恩': '/assets/players/銅雀足球俱樂部/張斳恩.png',
  '黃少威': '/assets/players/銅雀足球俱樂部/黃少威.png',
  '林晉威': '/assets/players/銅雀足球俱樂部/林晉威.png',
  '克魯茲': '/assets/players/銅雀足球俱樂部/克魯茲.jpg',
  
  // L1 - 酒號矯正署 [cite: 4]
  '林淮哲': '/assets/players/酒號矯正署/林淮哲.png',
  '何柏緯': '/assets/players/酒號矯正署/何柏緯.png',
  '李宗翰': '/assets/players/酒號矯正署/李宗翰.png',
  '黃有全': '/assets/players/酒號矯正署/黃有全.png',
  '顏廷邕': '/assets/players/酒號矯正署/顏廷邕.png',
  '陳吉龍': '/assets/players/酒號矯正署/陳吉龍.png',
  '謝孟軒': '/assets/players/酒號矯正署/謝孟軒.png',
  '曾健康': '/assets/players/酒號矯正署/曾健康.png',
  '許恩豪': '/assets/players/酒號矯正署/許恩豪.png',
  '李彼得': '/assets/players/酒號矯正署/李彼得.png',
  '林鈺閔': '/assets/players/酒號矯正署/林鈺閔.png',
  '林思維': '/assets/players/酒號矯正署/林思維.png',
  '林冠亨': '/assets/players/酒號矯正署/林冠亨.png',
  '鄭詠翰': '/assets/players/酒號矯正署/鄭詠翰.png',
  '陳揚青澔': '/assets/players/酒號矯正署/陳揚青澔.png',
  '吳啓明': '/assets/players/酒號矯正署/吳啓明.png',
  '施聖章': '/assets/players/酒號矯正署/施聖章.png',
  '劉庭嘉': '/assets/players/酒號矯正署/劉庭嘉.png',
  '何政緯': '/assets/players/酒號矯正署/何政緯.png',
  '洪毅瑋': '/assets/players/酒號矯正署/洪毅瑋.png',

  // L2 - 鹿逐俱樂部 [cite: 5]
  '陳麒竣': '/assets/players/鹿逐俱樂部/陳麒竣.png',
  '宋映德': '/assets/players/鹿逐俱樂部/宋映德.png',
  '謝詒婷': '/assets/players/鹿逐俱樂部/謝詒婷.png',
  '林伯仲': '/assets/players/鹿逐俱樂部/林伯仲.png',
  '李修沛': '/assets/players/鹿逐俱樂部/李修沛.png',
  '梶原航': '/assets/players/鹿逐俱樂部/梶原航.png',
  '鐘佳勳': '/assets/players/鹿逐俱樂部/鐘佳勳.png',
  '王子豪': '/assets/players/鹿逐俱樂部/王子豪.png',
  '陳泰盛': '/assets/players/鹿逐俱樂部/陳泰盛.png',
  '林敬祐': '/assets/players/鹿逐俱樂部/林敬祐.png',
  '陳穧元': '/assets/players/鹿逐俱樂部/陳穧元.png',
  '李祐任': '/assets/players/鹿逐俱樂部/李祐任.png',
  '蔡昀晏': '/assets/players/鹿逐俱樂部/蔡昀晏.png',
  '方韻雅': '/assets/players/鹿逐俱樂部/方韻雅.png',

  // L2 - 屏東野猿足球俱樂部 [cite: 6]
  '邱文良': '/assets/players/屏東野猿足球俱樂部/邱文良.png',
  '周宗德': '/assets/players/屏東野猿足球俱樂部/周宗德.png',
  '尤尚佑': '/assets/players/屏東野猿足球俱樂部/尤尚佑.png',
  '林彥文': '/assets/players/屏東野猿足球俱樂部/林彥文.png',
  '林大雄': '/assets/players/屏東野猿足球俱樂部/林大雄.png',
  '林聿堂': '/assets/players/屏東野猿足球俱樂部/林聿堂.png',
  '張春生': '/assets/players/屏東野猿足球俱樂部/張春生.png',
  '周承政': '/assets/players/屏東野猿足球俱樂部/周承政.png',
  '簡法亦': '/assets/players/屏東野猿足球俱樂部/簡法亦.png',
  '謝晉元': '/assets/players/屏東野猿足球俱樂部/謝晉元.png',
  '陳奕盛': '/assets/players/屏東野猿足球俱樂部/陳奕盛.png',
  '鄧進成': '/assets/players/屏東野猿足球俱樂部/鄧進成.png',
  '黃旭盛': '/assets/players/屏東野猿足球俱樂部/黃旭盛.png',
  '張富勝': '/assets/players/屏東野猿足球俱樂部/張富勝.png',
  '簡罡正': '/assets/players/屏東野猿足球俱樂部/簡罡正.png',
  '吳明遠': '/assets/players/屏東野猿足球俱樂部/吳明遠.png',
  '連哲緯': '/assets/players/屏東野猿足球俱樂部/連哲緯.png',
  '林韋堯': '/assets/players/屏東野猿足球俱樂部/林韋堯.png',
  '李偲瑋': '/assets/players/屏東野猿足球俱樂部/李偲瑋.png',
  '蘇靖堂': '/assets/players/屏東野猿足球俱樂部/蘇靖堂.png',

  // L2 - 瘋Dog [cite: 7]
  '黃震浩': '/assets/players/瘋Dog/黃震浩.png',
  '吳亦民': '/assets/players/瘋Dog/吳亦民.png',
  '林柏佑': '/assets/players/瘋Dog/林柏佑.png',
  '翁吉韡': '/assets/players/瘋Dog/翁吉韡.png',
  '王柏元': '/assets/players/瘋Dog/王柏元.png',
  '劉佳興': '/assets/players/瘋Dog/劉佳興.png',
  '文俊偉': '/assets/players/瘋Dog/文俊偉.png',
  '張博宇': '/assets/players/瘋Dog/張博宇.png',
  '徐鐸': '/assets/players/瘋Dog/徐鐸.png',
  '陳建宏': '/assets/players/瘋Dog/陳建宏.png',
  '趙學克': '/assets/players/瘋Dog/趙學克.png',
  '趙學邦': '/assets/players/瘋Dog/趙學邦.png',
  '江展宇': '/assets/players/瘋Dog/江展宇.png',
  '王亦瑋': '/assets/players/瘋Dog/王亦瑋.png',
  '戴威閎': '/assets/players/瘋Dog/戴威閎.png',
  '陳柏諧': '/assets/players/瘋Dog/陳柏諧.png',
  '蔡穎杰': '/assets/players/瘋Dog/蔡穎杰.png',

  // L2 - 鳥仕足球俱樂部 [cite: 8]
  '許御力': '/assets/players/鳥仕足球俱樂部/許御力.png',
  '王志誠': '/assets/players/鳥仕足球俱樂部/王志誠.png',
  '蔡軒誠': '/assets/players/鳥仕足球俱樂部/蔡軒誠.png',
  '于克元': '/assets/players/鳥仕足球俱樂部/于克元.png',
  '于克偉': '/assets/players/鳥仕足球俱樂部/于克偉.png',
  '蘇敦祺': '/assets/players/鳥仕足球俱樂部/蘇敦祺.png',
  '林欣楷': '/assets/players/鳥仕足球俱樂部/林欣楷.png',
  '邱睦容': '/assets/players/鳥仕足球俱樂部/邱睦容.png',
  '吳昱陞': '/assets/players/鳥仕足球俱樂部/吳昱陞.png',
  '鄭祖鏗': '/assets/players/鳥仕足球俱樂部/鄭祖鏗.png',
  '魏以恆': '/assets/players/鳥仕足球俱樂部/魏以恆.png',
  '李家諾': '/assets/players/鳥仕足球俱樂部/李家諾.png',
  '陳嫈文': '/assets/players/鳥仕足球俱樂部/陳嫈文.png',
  '陳光禪': '/assets/players/鳥仕足球俱樂部/陳光禪.png',
  '邱俊融': '/assets/players/鳥仕足球俱樂部/邱俊融.png',
  '莫嘉瑋': '/assets/players/鳥仕足球俱樂部/莫嘉瑋.png',
  '王竣弘': '/assets/players/鳥仕足球俱樂部/王竣弘.png',
  '林耀強': '/assets/players/鳥仕足球俱樂部/林耀強.png',
  '謝俊杰': '/assets/players/鳥仕足球俱樂部/謝俊杰.png',
  '劉偉洋': '/assets/players/鳥仕足球俱樂部/劉偉洋.png',

  // L2 - PPI TAINAN FC [cite: 9]
  '杰菲': '/assets/players/PPI TAINAN FC/杰菲.png',
  '木哈馬': '/assets/players/PPI TAINAN FC/木哈馬.png',
  'Iradaf Mandaya G.A Bahrun': '/assets/players/PPI TAINAN FC/Iradaf Mandaya G.A Bahrun.png',
  '萬地': '/assets/players/PPI TAINAN FC/萬地.png',
  '伊拉曼': '/assets/players/PPI TAINAN FC/伊拉曼.png',
  '伊而凡': '/assets/players/PPI TAINAN FC/伊而凡.png',
  '麥羅': '/assets/players/PPI TAINAN FC/麥羅.png',
  '泰普曼': '/assets/players/PPI TAINAN FC/泰普曼.png',
  '拉非': '/assets/players/PPI TAINAN FC/拉非.png',
  '孺立': '/assets/players/PPI TAINAN FC/孺立.png',
  '布丹': '/assets/players/PPI TAINAN FC/布丹.png',
  '高世科': '/assets/players/PPI TAINAN FC/高世科.png',
  'YEHUDA GAGAH WICAKSONO': '/assets/players/PPI TAINAN FC/YEHUDA GAGAH WICAKSONO.png',
  '優沙': '/assets/players/PPI TAINAN FC/優沙.png',
  '拉拉': '/assets/players/PPI TAINAN FC/拉拉.png',
  '阿麥德': '/assets/players/PPI TAINAN FC/阿麥德.png',
  '牙提': '/assets/players/PPI TAINAN FC/牙提.png',
  '蘇凡迪': '/assets/players/PPI TAINAN FC/蘇凡迪.png',
  
  // L2 - 蒼龍FC [cite: 10]
  '盧冠宇': '/assets/players/蒼龍FC/盧冠宇.png',
  '沈家弘': '/assets/players/蒼龍FC/沈家弘.png',
  '王浩誠': '/assets/players/蒼龍FC/王浩誠.png',
  '毛邦澤': '/assets/players/蒼龍FC/毛邦澤.png',
  '葉晉嘉': '/assets/players/蒼龍FC/葉晉嘉.png',
  '張丞均': '/assets/players/蒼龍FC/張丞均.png',
  '林聖恩': '/assets/players/蒼龍FC/林聖恩.png',
  '潘星宇': '/assets/players/蒼龍FC/潘星宇.png',
  '楊承諺': '/assets/players/蒼龍FC/楊承諺.png',
  '洪子程': '/assets/players/蒼龍FC/洪子程.png',
  '潘晨維': '/assets/players/蒼龍FC/潘晨維.png',
  '郭彥廷': '/assets/players/蒼龍FC/郭彥廷.png',
  '鄧子博': '/assets/players/蒼龍FC/鄧子博.png',
  '丁誌暉': '/assets/players/蒼龍FC/丁誌暉.png',
  '林湧鈞': '/assets/players/蒼龍FC/林湧鈞.png',
  '黃歷迦': '/assets/players/蒼龍FC/黃歷迦.png',
  '吳嘉華': '/assets/players/蒼龍FC/吳嘉華.png',
};
